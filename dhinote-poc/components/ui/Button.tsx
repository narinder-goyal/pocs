...
const Button: FC<Props> = ({ variant = 'primary', loading, children, className, ...props }) => {
  ...
  const variants: Record<string, string> = {
    primary: 'rounded-lg bg-[#156B5A] px-4 py-3 text-sm font-semibold text-white shadow-sm hover:bg-[#125a4b] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#156B5A] transition-colors',
    outline:
